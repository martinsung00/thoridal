...
import styles from "../../styles/menu_components/MenuUpdate.css";
import Modal from "react-modal";
import ModalContent from "./modal_components/update/Update";
...
export const Update: React.FunctionComponent<{}> = () => {
  ...
  return (
    <div>
      ...
      >
        <div className={styles.description}>Update a Trade</div>
        ...
        <div className={styles.arrowThree}>
          <div className={styles.arrowTop}></div>
          <div className={styles.arrowBottom}></div>
        </div>
      </div>
